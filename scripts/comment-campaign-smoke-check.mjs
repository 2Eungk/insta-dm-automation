  ...
  await build({
    stdin: {
      contents: `
        ...
        import { DEFAULT_COMMENT_CAMPAIGN_CONFIG, assessCommentCampaignSafety, commentMatchesCampaign } from "./src/domain/commentCampaign"
        ...
        export { DEFAULT_COMMENT_CAMPAIGN_CONFIG, assessCommentCampaignSafety, commentMatchesCampaign, normalizeMockMetaWebhookPayload, routeMetaRequest }
